<template>
  <div class="page-msgbox">
    ...
    <div class="page-msgbox-wrapper">
      <o-button @click="openAlert" size="large">打开 alert 提示框</o-button>
      <o-button @click="openConfirm" size="large">打开 confirm 提示框</o-button>
      <o-button @click="openPrompt" size="large">打开 prompt 提示框</o-button>
    </div>
  </div>
</template>
