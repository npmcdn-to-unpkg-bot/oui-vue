<template>
  <div>
    ...
    <group title="和input一起使用">
      ...
      <x-textarea :max="200" placeholder="描述"></x-textarea>
    </group>
    <group title="不显示计数器">
      <x-textarea :max="200" placeholder="请填写详细信息" :show-counter="false"></x-textarea>
    </group>
...
<script>
import { XTextarea, Group, XInput } from '../../src/'
